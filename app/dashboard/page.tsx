          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 lg:gap-8">
            ...
            <div className="hidden lg:block lg:col-span-3 xl:col-span-3 pl-2 xl:pl-4">
              <div className="sticky top-28 flex flex-col gap-3 pr-4">
                ...
                >
                  <img src={user?.photoURL || "https://api.dicebear.com/7.x/avataaars/svg?seed=" + profile?.name} alt="Avatar" className="w-11 h-11 rounded-full bg-white/5 border border-white/20 group-hover:border-[#d44df0] transition-colors"/>
              ...
              <div className="bg-white/[0.03] backdrop-blur-3xl sm:rounded-[24px] shadow-[0_8px_32px_rgba(0,0,0,0.4)] border-x-0 sm:border border-white/10 p-6 mb-8 relative overflow-hidden">
                ...
                <div className="flex gap-3 sm:gap-4 border-b border-white/10 pb-5">
                  <Link href={user ? `/profile/${user.uid}` : "#"}>
                    <img src={user?.photoURL || "https://api.dicebear.com/7.x/avataaars/svg?seed=" + profile?.name} alt="Avatar" className="w-12 h-12 rounded-full border-2 border-white/20 shadow-sm shrink-0 cursor-pointer hover:border-white/50 transition-colors"/>
                  </Link>
                          ...
                          <div className="flex space-x-4 items-center">
                            <Link href={post.isAnonymous ? "#" : `/profile/${post.uid}`} className="flex-shrink-0 cursor-pointer relative">
                              {post.isAnonymous ? (
                                ...
                                <img src={"https://api.dicebear.com/7.x/avataaars/svg?seed=" + post.authorName} alt="Avatar" className="h-12 w-12 rounded-full border-2 border-white/20 shadow-sm"/>
                              )}
                            </Link>
                            <div>
                            ...
                            >
                              <div className="p-6 space-y-6">
                                {(post.comments || []).map((cmt, idx) => (
                                  <div key={idx} className="flex gap-4">
                                    <Link href={`/profile/${cmt.uid}`}>
                                      <img src={"https://api.dicebear.com/7.x/avataaars/svg?seed=" + cmt.authorName} alt="Avatar" className="w-10 h-10 rounded-full border border-white/20 shrink-0 cursor-pointer hover:border-white/50 transition-colors"/>
                                    </Link>
                                ...
                                <div className="flex gap-4 items-start mt-6 pt-2">
                                  <img src={user?.photoURL || "https://api.dicebear.com/7.x/avataaars/svg?seed=" + profile?.name} alt="Avatar" className="w-10 h-10 rounded-full border border-white/20 shrink-0 mt-0.5 cursor-pointer"/>
                    ...
                    {suggestions.map(suggestion => (
                      ...
                      >
                        <div className="relative shrink-0">
                          <img src={"https://api.dicebear.com/7.x/avataaars/svg?seed=" + suggestion.name} className="h-11 w-11 rounded-full border-2 border-white/20 group-hover:border-[#00e5ff] transition-colors" alt="Avatar"/>
