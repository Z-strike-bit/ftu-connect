...
export default function Navbar({ profileName, profileId, profilePhoto, onSignOut }: NavbarProps) {
  ...
  const navItems = [
    ...
    { name: 'Tìm Mentor', path: '/find-mentor', icon: (
  ...
  return (
    <>
      {/* Top Navbar */}
      <nav className="bg-white/90 dark:bg-[#141414]/90 backdrop-blur-md border-b border-white/60 dark:border-[#1a1a1a] sticky top-0 z-50 h-16 sm:h-20 flex items-center justify-between px-4 sm:px-10 shadow-[0_4px_30px_rgb(0,0,0,0.03)] dark:shadow-none transition-colors duration-300">
        {/* Left: Logo */}
