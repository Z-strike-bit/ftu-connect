    ...
    <nav className="bg-white border-b border-slate-200 sticky top-0 z-50 h-16 flex items-center justify-between px-4 shadow-sm">
      ...
      <div className="flex items-center gap-4 w-1/3 relative">
        <Link href="/dashboard" className="shrink-0 flex items-center">
          <Image src="/logo-ftu-connect.png" alt="FTU Connect" width={1000} height={250} className="w-[150px] sm:w-[250px] h-auto object-contain cursor-pointer scale-125 sm:scale-150 origin-left" />
        </Link>
        <div className="hidden lg:flex items-center bg-[#f0f2f5] rounded-full px-3 py-2 w-64 h-10 shrink-0 ml-12">
