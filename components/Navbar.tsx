  ...
  return (
    <nav className="bg-white border-b border-slate-200 sticky top-0 z-50 h-14 flex items-center justify-between px-4 shadow-sm">
      ...
      <div className="flex items-center gap-2 w-1/4">
        <Link href="/dashboard" className="shrink-0 flex items-center pl-2">
          <Image src="/logo.png" alt="FTU Connect" width={240} height={80} className="h-12 sm:h-14 w-auto object-contain" />
        </Link>
        <div className="hidden md:flex items-center bg-[#f0f2f5] rounded-full px-3 py-2 ml-2 w-64 h-10">
